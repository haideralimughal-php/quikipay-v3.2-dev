                             ...
                             <label>Customer Email:</label>
                                <select class="form-control select2" name="customerEmail" style="width: 100%;">
                                    <option selected="selected">All</option>
            								...
            								<option>{{$email['customer_email']}}</option>
            						        @endforeach
                                 </select>
		    ...
		    <div class="card card-primary card-outline card-tabs table-responsive">
                <div class="card-header p-0 pt-1 border-bottom-0">
                    <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="confirm-trasactions-tab" data-toggle="pill" href="#confirm-trasactions-content" role="tab" aria-controls="confirm-trasactions-content" aria-selected="true">Confirmed</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pending-trasactions-tab" data-toggle="pill" href="#pending-trasactions-content" role="tab" aria-controls="pending-trasactions-content" aria-selected="false">Pending</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" id="reject-trasactions-tab" data-toggle="pill" href="#reject-trasactions-content" role="tab" aria-controls="reject-trasactions-content" aria-selected="false">Rejected</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                        <!-- Date range -->
                        @isset($ActiveTab)
                        <input type="hidden" value="{{$ActiveTab}}" id="ToActiveTab">
                            @endisset
                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                        ...
                        <div class="tab-pane fade" id="pending-trasactions-content" role="tabpanel" aria-labelledby="pending-trasactions-tab">
        							...
        							@if(count($transactions['pending']))
        								@foreach($transactions['pending'] as $transaction)
        									<tr>
        										...
        										<td class="text-nowrap">{{ $transaction->customer_name }}</td>
                        ...
                        <div class="tab-pane fade" id="reject-trasactions-content" role="tabpanel" aria-labelledby="reject-trasactions-tab">
