...
@section('content')
    ...
    <div class="accordion" id="accordionExample">
          ...
          <h2 class="mb-0">
            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
              <div class="d-flex align-items-center text-success">
                  <i class="fa fa-university fa-2x pr-4"></i><h5 class="text-success pt-2"><b>{{__('data.lBank')}}</b></h5>
              </div>
            </button>
          </h2>
        </div>
          ...
          <div class="card-body">
            <form class="row" action="/withdraw" method="post" id="with-form">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="country" required="" class="form-control option-custom-style select2" onchange="getcountry()" id="getCountry" >
                ...
                <div class="form-group col-md-6 d-none" id="bankSelect">
                    ...
                    <select name="bank_name" required="" class="form-control option-custom-style ">
                        ...
                        @endif
                        <optgroup label="Chile" style="background-color:#0074f0; color:white; font-size:18px; padding:15;">
                        ...
                        <optgroup label="Panama&#769;" style="background-color:#0074f0; color:white; font-size:18px; padding:15;">
                        ...
                        <optgroup label="PERU" style="background-color:#0074f0; color:white; font-size:18px; padding:15;">
                            <option value="Banco de Comercio">Banco de Comercio</option>
                            <option value="Banco de Cr��dito del Peru&#769;">Banco de Cr��dito del Peru&#769;</option>
                        ...
                        <optgroup label="Venezuela" style="background-color:#0074f0; color:white; font-size:18px; padding:15;">
                            ...
                            <option value="Banco Nacional de Cr��dito BNC">Banco Nacional de Cr��dito BNC</option>
                            <option value="BFC">BFC</option>
                            <option value="Venezolano de Cr��dito">Venezolano de Cr��dito</option>
                        ...
                        <optgroup label="Argentina" style="background-color:#0074f0; color:white; font-size:18px; padding:15;">
                            ...
                            <option value="BANCO PROVINCIA DEL NEUQU�0�7N SOCIEDAD AN�0�7">BANCO PROVINCIA DEL NEUQU�0�7N SOCIEDAD AN�0�7</option>
                            ...
                            <option value="FORD CREDIT COMPA�0�5IA FINANCIERA S.A.">FORD CREDIT COMPA�0�5IA FINANCIERA S.A.</option>
                            <option value="COMPA�0�5IA FINANCIERA ARGENTINA S.A.">CCOMPA�0�5IA FINANCIERA ARGENTINA S.A.</option>
                            <option value="VOLKSWAGEN FINANCIAL SERVICES COMPA�0�5IA F">VOLKSWAGEN FINANCIAL SERVICES COMPA�0�5IA F</option>
                            <option value="CORDIAL COMPA�0�5I&#769;A FINANCIERA S.A.">CORDIAL COMPA�0�5I&#769;A FINANCIERA S.A.</option>
                            <option value="FCA COMPA�0�5IA FINANCIERA S.A.">FCA COMPA�0�5IA FINANCIERA S.A.</option>
                            <option value="GPAT COMPA�0�5IA FINANCIERA S.A.U.">GPAT COMPA�0�5IA FINANCIERA S.A.U.</option>
                            <option value="MERCEDES-BENZ COMPA�0�5I&#769;A FINANCIERA ARGENT">MERCEDES-BENZ COMPA�0�5I&#769;A FINANCIERA ARGENT</option>
                            <option value="ROMBO COMPA�0�5I&#769;A FINANCIERA S.A.">ROMBO COMPA�0�5I&#769;A FINANCIERA S.A.</option>
                            <option value="JOHN DEERE CREDIT COMPA�0�5I&#769;A FINANCIERA S.">JOHN DEERE CREDIT COMPA�0�5I&#769;A FINANCIERA S.</option>
                            <option value="PSA FINANCE ARGENTINA COMPA�0�5I&#769;A FINANCIER">PSA FINANCE ARGENTINA COMPA�0�5I&#769;A FINANCIER</option>
                            <option value="TOYOTA COMPA�0�5I&#769;A FINANCIERA DE ARGENTINA">TOYOTA COMPA�0�5I&#769;A FINANCIERA DE ARGENTINA</option>
                            <option value="MONTEMAR COMPA�0�5IA FINANCIERA S.A.">MONTEMAR COMPA�0�5IA FINANCIERA S.A.</option>
                            <option value="TRANSATLANTICA COMPA�0�5IA FINANCIERA S.A.">TRANSATLANTICA COMPA�0�5IA FINANCIERA S.A.</option>
                            <option value="CREDITO REGIONAL COMPA�0�5IA FINANCIERA S.A">CREDITO REGIONAL COMPA�0�5IA FINANCIERA S.A</option>
                        </optgroup>
                    </select>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="account_type" required="" class="form-control select2">
                        @if(!is_null($local_bank))
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2" name="currency" required="" id="local-currency">
          ...
          <h2 class="mb-0">
            <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                <div class="d-flex align-items-center text-warning">
                    <i class="fa fa-university fa-2x pr-4"></i><h5 class="text-warning pt-2"><b>{{__('data.iBank')}}</b></h5>
                </div>  
            </button>
          </h2>
        </div>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
          <div class="card-body">
            <form class="row" action="/withdraw" method="post" id="with-form">
                ...
                <div class="form-group col-md-6">
                    <label>{{__('data.currency')}}</label>
                    <select class="form-control select2" name="currency" required="" id="international-currency">
                        <option value="" selected>--Select Currency--</option>
                        <option value="CLP">CLP</option>
                        <option value="USD">USD</option> 
                        <option value="ARS">ARS</option>
        ...
        <div class="card">
            <div class="card-header" id="headinsecondary">
                <h2 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                    <div class="d-flex align-items-center text-primary">
                        <i class="fab fa-paypal fa-2x pr-4"></i><h5 class="pt-2"><b>Pay<span class="text-info">Pal</span></b></h5>
                    </div>
                    </button>
                </h2>
            </div>
                ...
                <div class="card-body">
                    <form class="row" action="/withdraw" method="post" id="with-form">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" required="" name="email" placeholder="email@eample.com" value="{{ !is_null($paypal) ? $paypal->email : '' }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{__('data.currency')}}</label>
                            <select class="form-control select2" name="currency" required="" id="paypal-currency">
                                <option value="" selected>--Select Currency--</option>
                                <option value="CLP">CLP</option>
                                <option value="USD">USD</option>
                                <option value="ARS">ARS</option>
                        ...
                        <div class="form-group col-md-6">
                            <label>{{__('data.amount')}}</label>
                            <input type="number" min="1" class="form-control" required="" name="amount" id="paypal-amount">
                        </div>
                        <div class="form-group col-md-12">
                            <input type="submit" value="{{__('data.withdraw')}}" class="btn btn-success">
                        </div>
                ...
                <h2 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        <div class="d-flex align-items-center text-secondary">
                            <i class="fab fa-ethereum fa-2x pr-4"></i><h5 class="text-danger pt-2"><b>Cryptocurrency</b></h5>
                        </div>
                    </button>
                </h2>
            </div>
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                <div class="card-body">
                    ...
                    <form class="row" action="/withdraw" method="post" id="with-form">
                        @csrf
                        <input type="hidden" name="type" value="{{ $param }}" />
                        <input type="hidden" name="bank" value="crypto" />
                        <fieldset class="col-12 mt-2 d-none">
                            <h3 class="text-left">{{__('data.merchant_info')}}:</h3>
                            <p class="px-2"><span class="pr-5"><b>{{__('data.merchant_name')}}:</b></span>{{ auth()->user()->name }}</p>
                        </fieldset>
                        <div class="col-12 mt-4">
                            <h3 class="text-center text-uppercase text-info mb-5 "><b>{{__('data.withdraw_from')}}</b></h3>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label class="">{{__('data.selectcurrencywidth')}}</label>
                                            <select class="form-control select2  " name="currency" required="" id="crypto-currency">
                                                <option value="" selected>--Select Currency--</option>
                                                <option value="CLP">CLP</option>
                                                <option value="USD">USD</option>
                                                <option value="ARS">ARS</option>
                                    ...
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label class="">{{__('data.amount')}}</label>
                                            <input type="number" min="1" class="  form-control" required="" name="amount" id="crypto-amount">
                                        </div>    
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 mt-4">
                            <h3 class="text-center text-uppercase text-danger "><b>{{__('data.withdraw_to')}}</b></h3>
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label class="">{{__('data.SCWYWW')}}</label>
                                            <select class="form-control   select2"  name="crypto_currency" required="" id="crypto">
                                                <option value="" disbaled selected>--Select Crypto Currency--</option>
                                    ...
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label class="">{{__('data.PECWWA')}}</label><a class="ml-3" href="{{ url('merchants_wallet_addresses') }}">{{__('data.addNewAddress')}}</a>
                                            <!--<input type="text" class="  form-control" required="" name="crypto_address" placeholder="e.g. 1M2qz2Dy4ZxnDvZF72s6jwauFb6UN6jjrR" value="{{ !is_null($crypto) ? $crypto->email : '' }}">-->
                                            <select class="form-control" required=""  id="crypto_address" name="crypto_address">
                        ...
                        <div class="col-12 mt-4">
                            <h3 class="text-center text-success"><b>{{__('data.exchange_rate')}}</b></h3>
                            <div class="container-fluid">
                                <p class="text-center py-2 text-secondary"><b>{{__('data.checkExchangeRate')}}</b></p>
                                <div class="row">
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label>Equivalent Crypto Currency</label>
                                            
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" id="equivalentCrypto" disabled >
                                                    <div class="input-group-append">
                                                        <button class="btn btn-success from-control" id="checkEquivalentCryptoCurrency" type="button">Check</button>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 offset-md-3 col-12">
                                        <div class="form-group">
                                            <label>Crypto Currency Rate</label>
                                            <div class="d-flex">
                                                
                                              <input type="text" class="form-control" id="exchangeRate" readonly name="fx_rate"/>
                        ...
                        <div class="form-group col-md-6 offset-md-3 col-12 pt-4 text-right">
                            <input type="submit" value="{{__('data.withdraw')}}" class="btn btn-success">
                        </div>
                    </form>
                </div>
        ...
        $(document).ready(function(){
            ...
            $('#crypto').on('change', function(){
                ...
                var crypto=$("#crypto").val();
                    $.ajax({
                        type : "POST",
                        url : "/merchants_wallet_addresses/specific",
                        data : {"_token": "{{ csrf_token() }}",crypto:crypto},
                        success : function (resp) {
                            $(".loader2").hide();
                            $("#crypto_address").html(resp);
                        },
                        error : function (resp) {
                            $(".loader2").hide();
            ...
            $('#paypal-currency').on('change', function(){
                console.log($(this).val());
                var currency = $(this).val();

                switch (currency){
                    case 'USD':
                    $('#paypal-amount').attr('max', '{{ auth()->user()->wallet->usd }}');
                    break;
                    case 'ARS':
                    $('#paypal-amount').attr('max', '{{ auth()->user()->wallet->ars }}');
                    break;
                    case 'CLP':
                    $('#paypal-amount').attr('max', '{{ auth()->user()->wallet->clp }}');
                    break;
                    case 'SOL':
                    $('#paypal-amount').attr('max', '{{ auth()->user()->wallet->sol }}');
                    break;
                }
            });
            $('#crypto-currency').on('change', function(){
                ...
                switch (currency){
                    case 'USD':
                    $('#crypto-amount').attr('max', '{{ auth()->user()->wallet->usd }}');
                    break;
                    case 'ARS':
                    $('#crypto-amount').attr('max', '{{ auth()->user()->wallet->ars }}');
                    break;
                    case 'CLP':
                    $('#crypto-amount').attr('max', '{{ auth()->user()->wallet->clp }}');
                    break;
                    case 'SOL':
                    $('#crypto-amount').attr('max', '{{ auth()->user()->wallet->sol }}');
                    break;
                }
            });
            $('#crypto-currency').trigger('change');
            $('#paypal-currency').trigger('change');
            $('#local-currency').trigger('change');
            $('#international-currency').trigger('change');
            
            $("#checkEquivalentCryptoCurrency").click(function() {
                let crypto = $("#crypto").val();
                let fiat = $("#crypto-currency").val();
                let amount = $("#crypto-amount").val();
                
                if(crypto && fiat && amount) {
                    $(".loader2").show();
                    $.ajax({
                        type : "GET",
                        url : "/get-equivalent-crypto",
                        data : {crypto, fiat, amount},
                        success : function (resp) {
                            $(".loader2").hide();
                            $("#equivalentCrypto").val(resp.equivalentCrypto.toFixed(8) + " " + crypto );
                            $("#exchangeRate").val("1 " + fiat + " = " + resp.rate.toFixed(8) +" "+ crypto );
