                       ...
                       <form method="post" action="/pay/blockfortrequest">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" onkeypress="return isNumberKey(event)" name="number" id="number" size="20" autocomplete="off" class="form-control border-left-0"  placeholder="4256 1233 4566 1254" onblur="numberCheck()" required>
                            </div>
                            <div id="error1"></div>
                            <div id="cardtype"></div>
                          </div>
                        ...
                        <div class="container text-center  d-flex align-items-center justify-content-center">
                            ...
                            <img src="{{ asset('payImages/america-Express.png') }}" width="70px" height="auto" class="img-fluid pt-3">
                        </div>
                   </div>
                </div>
            </div>
...
<script>
    ...
    function numberCheck()
    {
        ...
        // var cardtype=cc_brand_id(numberValue);
